...
class LinearPipeLayer(ConvPipeLayer):
    def __init__(self,linear_config,input_shape,output_shape,misc_config):
        ...
        conv_config = {
            ...
            'activation_func':linear_config['activation_func']
        }

        # input_shape = (1,1,self.in_features)
        # output_shape = (1,1,self.out_features)

        super(LinearPipeLayer, self).__init__(conv_config, input_shape, output_shape, misc_config)
