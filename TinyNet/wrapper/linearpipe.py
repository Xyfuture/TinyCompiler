...
from TinyNet.modules.linearpipe import LinearPipeLayer
...
class Linear(module):
    def __init__(self,in_features,out_features,bias=True,activation_func='relu'):
        ...
        self.input_shape = []
        self.output_shape = []
        self.linear_layer:LinearPipeLayer = None
    ...
    def allocate(self):
        self.linear_layer = LinearPipeLayer(self.linear_config,self.input_shape,self.output_shape,self.misc_config)
